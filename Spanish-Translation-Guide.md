...
- Use established Spanish cybersecurity terminology where available
...
- Maintain "Think for Yourself" philosophy in Spanish
...
## 🏛️ Spanish Regulatory Framework

### Key Regulatory Bodies

**Data Protection:** AEPD (Agencia Española Protección Datos)  
**Cybersecurity:** CCN-CERT (Centro Criptológico Nacional)  
**Certification:** ENAC (Entidad Nacional de Acreditación)  


### Local Standards & Requirements

- **ISO 27001**: Spanish implementation and certification requirements
- **GDPR**: European data protection regulation (if applicable)
- **NIS2**: Network and Information Security Directive (EU)
- **Local Data Protection Laws**: [Add specific Spanish requirements]
...
All pages must include proper Schema.org markup with `inLanguage: "es"`:
...
2. Review the Spanish-Translation-Status.md file for current progress
...
1. **Copy English source file** to `[filename]_es.html`
...
- [ ] lang="es" attribute set correctly
...
- Final review by native Spanish speaker
...
- **Translation Status:** See `Spanish-Translation-Status.md`
- **Master Documentation:** `TRANSLATION_DOCUMENTATION_README.md`
- **English Source Files:** `*.html` (base files)
- **Spanish Files:** `*_es.html`
