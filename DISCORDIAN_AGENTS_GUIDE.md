...
graph TB
    subgraph "The Consciousness Expansion Architecture"
        ...
        subgraph "The CIA Trinity"
            C[Confidentiality Path<br/>5 Levels]:::confidentiality
            I[Integrity Path<br/>5 Levels]:::integrity
            A[Availability Path<br/>5 Levels]:::availability
        end
