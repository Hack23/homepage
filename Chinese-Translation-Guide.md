...
- Use established Chinese cybersecurity terminology where available
...
- Maintain "Think for Yourself" philosophy in Chinese
...
## 🏛️ Chinese Regulatory Framework

### Key Regulatory Bodies

**Data Protection:** PIPL (Personal Information Protection Law)  
**Cybersecurity:** CAC (Cyberspace Administration of China)  
**Standards:** GB/T 22080 (China ISO 27001 equivalent)  


### Local Standards & Requirements

- **ISO 27001**: Chinese implementation and certification requirements
- **GDPR**: European data protection regulation (if applicable)
- **NIS2**: Network and Information Security Directive (EU)
- **Local Data Protection Laws**: [Add specific Chinese requirements]
...
All pages must include proper Schema.org markup with `inLanguage: "zh"`:
...
2. Review the Chinese-Translation-Status.md file for current progress
...
1. **Copy English source file** to `[filename]_zh.html`
...
- [ ] lang="zh" attribute set correctly
...
- Final review by native Chinese speaker
...
- **Translation Status:** See `Chinese-Translation-Status.md`
- **Master Documentation:** `TRANSLATION_DOCUMENTATION_README.md`
- **English Source Files:** `*.html` (base files)
- **Chinese Files:** `*_zh.html`
