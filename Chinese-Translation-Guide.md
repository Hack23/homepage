...
graph LR
    subgraph "📚 Chinese Translation Workflow"
...
graph TB
    subgraph "🏆 Chinese Translation Quality Pyramid"
...
| English | Chinese | Context | ISO/Framework |
|---------|-------|---------|---------------|
...
| English | Chinese | ISO Reference | Policy Type |
|---------|-------|---------------|-------------|
...
| English | Chinese | Context | Regulatory |
|---------|-------|---------|------------|
