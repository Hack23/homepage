...
This guide provides comprehensive instructions for creating and maintaining Finnish language translations for the Hack23 AB website.
...
- Use established Finnish cybersecurity terminology where available
...
- Maintain "Think for Yourself" philosophy in Finnish
...
## 🏛️ Finnish Regulatory Framework
...
- **ISO 27001**: Finnish implementation and certification requirements
- **GDPR**: European data protection regulation (if applicable)
- **NIS2**: Network and Information Security Directive (EU)
- **Local Data Protection Laws**: [Add specific Finnish requirements]
...
All pages must include proper Schema.org markup with `inLanguage: "fi"`:
...
2. Review the Finnish-Translation-Status.md file for current progress
...
1. **Copy English source file** to `[filename]_fi.html`
...
- [ ] lang="fi" attribute set correctly
...
- Final review by native Finnish speaker
...
- **Translation Status:** See `Finnish-Translation-Status.md`
- **Master Documentation:** `TRANSLATION_DOCUMENTATION_README.md`
- **English Source Files:** `*.html` (base files)
- **Finnish Files:** `*_fi.html`
