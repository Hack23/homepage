...
- Use **industry-standard terminology** recognized in French

#### 2. 🎯 Technical Consistency
- **Preserve English terms** where widely accepted internationally:
  - DevSecOps, CI/CD, GitHub, Docker, Kubernetes, API, REST
- **Use established French terminology** for cybersecurity concepts
...
- **Reference local regulations**: GDPR, NIS2, and French-specific laws
...
graph LR
    subgraph "📚 French Translation Workflow"
...
graph TB
    subgraph "🏆 French Translation Quality Pyramid"
...
|---------|-------------|
| FNORD | FNORD |
| Think for Yourself | Pensez par vous-même |
| Question Authority | Remettez en question l'autorité |
| Chapel Perilous | Chapel Perilous |
| Eris | Eris |
| Law of Fives | Loi des Cinq |
| Information Hoarding | Accaparement d'information |
| Transparency | Transparence |
| Security Theater | Théâtre de sécurité |
...
2. ✅ Review the `French-Translation-Status.md` file
...
5. ✅ Set up development environment:
   - Text editor with French language support
   - HTML validator
   - Browser for testing
...
**Actions:**
1. ✅ **Copy source file**: `page.html` → `page_fr.html`
...
2. ✅ **Grammar & spelling**:
   - Use French spell checker
   - Review sentence structure
   - Check punctuation
3. ✅ **Cultural appropriateness**:
   - Examples relevant to French market
...
<head>
    ...
    <meta name="keywords" content="[keywords, in, french]">
    
    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://hack23.com/[page]_fr.html">
    ...
    <meta property="twitter:url" content="https://hack23.com/[page]_fr.html">
    <meta property="twitter:title" content="[Title in French]">
    <meta property="twitter:description" content="[Description in French]">
    ...
    <!-- Canonical -->
    <link rel="canonical" href="https://hack23.com/[page]_fr.html">
    ...
    <script type="application/ld+json">
    {
        ...
        "inLanguage": "fr",
        "url": "https://hack23.com/[page]_fr.html",
        "isPartOf": {
            "@type": "WebSite",
            "name": "Hack23",
        ...
        "breadcrumb": {
            ...
            "itemListElement": [
                ...
                },
                {
                    ...
                    "position": 2,
                    "name": "[Page Name in French]",
                    "item": "https://hack23.com/[page]_fr.html"
                }
            ]
        }
    }
...
- ✅ Sentence structure follows French norms
...
- ❌ Force English idioms into French
...
**French Language:**
- **Dictionary**: [Add recommended French dictionary]
- **Grammar**: [Add French grammar reference]
- **Style Guide**: [Add French business writing guide]
...
- **French Translation Files**: `*_fr.html` (58 files)
...
- **Question assumptions**: Is this the best French term?
- **Consider context**: What does this mean to a French reader?
- **Preserve intent**: Does my translation convey the original purpose?
- **Adapt wisdom**: How can I make Discordian philosophy resonate in French culture?
...
Translation is both art and science. Use this guide wisely, think for yourself, and create excellent French content for the global cybersecurity community.
...
**Essential Links:**
- Status: `French-Translation-Status.md`
