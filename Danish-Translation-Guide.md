...
This guide provides comprehensive instructions for creating and maintaining Danish language translations for the Hack23 AB website.
...
- Use established Danish cybersecurity terminology where available
...
- Maintain "Think for Yourself" philosophy in Danish
...
- **ISO 27001**: Danish implementation and certification requirements
- **GDPR**: European data protection regulation (if applicable)
- **NIS2**: Network and Information Security Directive (EU)
- **Local Data Protection Laws**: [Add specific Danish requirements]
...
All pages must include proper Schema.org markup with `inLanguage: "da"`:
...
2. Review the Danish-Translation-Status.md file for current progress
...
1. **Copy English source file** to `[filename]_da.html`
...
- [ ] lang="da" attribute set correctly
...
- Final review by native Danish speaker
...
- **Translation Status:** See `Danish-Translation-Status.md`
- **Master Documentation:** `TRANSLATION_DOCUMENTATION_README.md`
- **English Source Files:** `*.html` (base files)
- **Danish Files:** `*_da.html`
