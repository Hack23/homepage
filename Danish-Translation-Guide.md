...
- Use **industry-standard terminology** recognized in Danish

#### 2. 🎯 Technical Consistency
- **Preserve English terms** where widely accepted internationally:
  - DevSecOps, CI/CD, GitHub, Docker, Kubernetes, API, REST
- **Use established Danish terminology** for cybersecurity concepts
...
- **Reference local regulations**: GDPR, NIS2, and Danish-specific laws
...
graph LR
    subgraph "📚 Danish Translation Workflow"
...
graph TB
    subgraph "🏆 Danish Translation Quality Pyramid"
...
2. ✅ Review the `Danish-Translation-Status.md` file
...
5. ✅ Set up development environment:
   - Text editor with Danish language support
   - HTML validator
   - Browser for testing
...
**Actions:**
1. ✅ **Copy source file**: `page.html` → `page_da.html`
...
2. ✅ **Grammar & spelling**:
   - Use Danish spell checker
   - Review sentence structure
   - Check punctuation
3. ✅ **Cultural appropriateness**:
   - Examples relevant to Danish market
...
<head>
    ...
    <!-- Primary Meta Tags -->
    <title>[Page Title in Danish]</title>
    <meta name="description" content="[Meta description in Danish]">
    <meta name="keywords" content="[keywords, in, danish]">
    
    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://hack23.com/[page]_da.html">
    <meta property="og:title" content="[Title in Danish]">
    <meta property="og:description" content="[Description in Danish]">
    <meta property="og:locale" content="da_DK">
    
    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="https://hack23.com/[page]_da.html">
    <meta property="twitter:title" content="[Title in Danish]">
    <meta property="twitter:description" content="[Description in Danish]">
    ...
    <!-- Canonical -->
    <link rel="canonical" href="https://hack23.com/[page]_da.html">
    ...
    <script type="application/ld+json">
    {
        "@context": "https://schema.org",
        "@type": "WebPage",
        "name": "[Page Name in Danish]",
        "description": "[Description in Danish]",
        "inLanguage": "da",
        "url": "https://hack23.com/[page]_da.html",
        "isPartOf": {
            "@type": "WebSite",
            "name": "Hack23",
        ...
        "breadcrumb": {
            ...
            "itemListElement": [
                ...
                },
                {
                    ...
                    "position": 2,
                    "name": "[Page Name in Danish]",
                    "item": "https://hack23.com/[page]_da.html"
                }
            ]
        }
    }
...
- ✅ Sentence structure follows Danish norms
...
**Technical Review:**
- [ ] HTML well-formed
- [ ] lang="da" set correctly
- [ ] og:locale = da_DK
- [ ] All 14 hreflang tags present
- [ ] Schema.org inLanguage = "da"
...
- ❌ Force English idioms into Danish
...
**Danish Language:**
- **Dictionary**: [Add recommended Danish dictionary]
- **Grammar**: [Add Danish grammar reference]
- **Style Guide**: [Add Danish business writing guide]
...
- **Translation Status**: `Danish-Translation-Status.md`
- **Master Documentation**: `TRANSLATION_DOCUMENTATION_README.md`
- **English Source Files**: `*.html` (base files)
- **Danish Translation Files**: `*_da.html` (72 files)
...
- **Question assumptions**: Is this the best Danish term?
- **Consider context**: What does this mean to a Danish reader?
- **Preserve intent**: Does my translation convey the original purpose?
- **Adapt wisdom**: How can I make Discordian philosophy resonate in Danish culture?
...
Translation is both art and science. Use this guide wisely, think for yourself, and create excellent Danish content for the global cybersecurity community.
...
**Essential Links:**
- Status: `Danish-Translation-Status.md`
